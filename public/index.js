...
var isUserAgentChrome = function() {
...
tour.addStep( 'sound3', {
  ...
  text: function() {
    write( function() {
      if ( isUserAgentChrome() ) {
        return ( "* But, hey, it looks like YOU won't be running into THAT problem!    \\n* Hee hee hee!" )
      } else {
        return ( "* Whatever." )
      }
    }(), "sound3", "01t", function() {
...
tour.addStep( 'end2', {
  ...
  text: function() {
    zToCont.unregister_combo( "x" );
    write( "* Did you think that you could just press the little 'x' and all your worries would be gone?   β* Wow. You really ARE an-", "end2", "02t", null, {
      shake: true
    } );
...
tour.addStep( 'end4', {
  title: '',
  text: function() {
    $( ".shepherd-content" ).on( "click", function() {
      tour.next();
    } );
    $( ".shepherd-text" ).on( "click", function() {
      tour.next();
    } );
...
var chS = [ {
  forease: "of use",
  yup: function() {
    Materialize.toast( "<h1 class=\"shake-little shake-constant mon\">The Ones Who Don&apos;t QUIT</h1>", 5000, "primary" );
    return false;
  }
}, {
