...
script2.addStep('06', {
    ...
    text: function () {
        setTimeout(function () {
            write("THAT'S TRUE, ACTUALLY; DESPITE WHAT MANY MAY BE LED TO BELIEVE.", "06", "WD");
        }, 100);
...
script2.addStep('065', {
    ...
    text: function () {
        setTimeout(function () {
            write($Story.name + " WAS VERY GOOD COMPANY, AS WAS LITTLE FLUFFY AZ, HERE.", "065", "WD", null, {delay: 100});
        }, 100);
